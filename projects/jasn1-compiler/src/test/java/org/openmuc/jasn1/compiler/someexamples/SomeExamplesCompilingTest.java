...
import org.example.compiler.simalliance.generated.pedefinitions.ProfileElement;
import org.example.compiler.simalliance.generated.pedefinitions.ProfileHeader;
import org.example.compiler.simalliance.generated.pedefinitions.UInt8;
...
//
//                ));
//        berByteArrayOutputStream = new BerByteArrayOutputStream(2048, true);
//        genericFileManagementProfileElement.encode(berByteArrayOutputStream, false);
//        code = berByteArrayOutputStream.getArray();
//        System.out.println(Hex.encodeHexString(code));
//        rereadProfileElement = new ProfileElement();
//        rereadProfileElement.decode(new ByteArrayInputStream(code), null);
//        berByteArrayOutputStream2 = new BerByteArrayOutputStream(2048, true);
//        rereadProfileElement.encode(berByteArrayOutputStream2, false);
//        code2 = berByteArrayOutputStream2.getArray();
//        assertEquals(Hex.encodeHexString(code), Hex.encodeHexString(code2));
    }
