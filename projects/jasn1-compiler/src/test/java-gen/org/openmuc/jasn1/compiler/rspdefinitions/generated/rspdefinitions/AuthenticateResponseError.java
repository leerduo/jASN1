...
public class AuthenticateResponseError {
	...
	public AuthenticateErrorCode authenticateErrorCode = null;
	...
	public AuthenticateResponseError(TransactionId transactionId, AuthenticateErrorCode authenticateErrorCode) {
		id = identifier;
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			codeLength = 0;
			codeLength += authenticateErrorCode.encode(os, true);
	...
	public int decode(InputStream is, boolean explicit) throws IOException {
		...
		if (berIdentifier.equals(AuthenticateErrorCode.identifier)) {
			authenticateErrorCode = new AuthenticateErrorCode();
			subCodeLength += authenticateErrorCode.decode(is, false);
