...
public class InstallationResultCode extends BerInteger {

	public InstallationResultCode() {
	}

	public InstallationResultCode(byte[] code) {
		super(code);
	}

	public InstallationResultCode(long value) {
		super(value);
	}
