...
public class SetNicknameResponse {
	...
	public SetNicknameResponse(byte[] code) {
		id = identifier;
		this.code = code;
	}

	public SetNicknameResponse(BerInteger setNicknameResult) {
		id = identifier;
		this.setNicknameResult = setNicknameResult;
	}
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			codeLength = 0;
			codeLength += setNicknameResult.encode(os, false);
	...
	public int decode(InputStream is, boolean explicit) throws IOException {
		...
		if (berIdentifier.equals(BerIdentifier.CONTEXT_CLASS, BerIdentifier.PRIMITIVE, 0)) {
			...
			subCodeLength += setNicknameResult.decode(is, false);
	...
	public String toString() {
		...
		sb.append("setNicknameResult: ").append(setNicknameResult);
