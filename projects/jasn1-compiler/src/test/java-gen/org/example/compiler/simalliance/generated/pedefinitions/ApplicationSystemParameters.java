...
public class ApplicationSystemParameters {
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			if (nonVolatileReservedMemory != null) {
				...
				// write tag {PRIVATE_CLASS, PRIMITIVE, 5}
				os.write(0xc5);
				codeLength += 1;
			}
			...
			if (implicitSelectionParameter != null) {
				...
				// write tag {PRIVATE_CLASS, PRIMITIVE, 3}
				os.write(0xc3);
				codeLength += 1;
			}
	...
	public int decode(InputStream is, boolean explicit) throws IOException {
		...
		if (length.val == -1) {
			...
			if (berIdentifier.equals(BerIdentifier.PRIVATE_CLASS, BerIdentifier.PRIMITIVE, 3)) {
			...
			if (berIdentifier.equals(BerIdentifier.PRIVATE_CLASS, BerIdentifier.PRIMITIVE, 5)) {
