...
public class PrepareDownloadResponseError {
	...
	public DownloadErrorCode downloadErrorCode = null;

	public PrepareDownloadResponseError() {
		id = identifier;
	}

	public PrepareDownloadResponseError(byte[] code) {
		id = identifier;
		this.code = code;
	}

	public PrepareDownloadResponseError(TransactionId transactionId, DownloadErrorCode downloadErrorCode) {
		id = identifier;
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			codeLength = 0;
			codeLength += downloadErrorCode.encode(os, true);
	...
	public int decode(InputStream is, boolean explicit) throws IOException {
		...
		if (totalLength == -1) {
			...
			if (berIdentifier.equals(DownloadErrorCode.identifier)) {
				downloadErrorCode = new DownloadErrorCode();
				subCodeLength += downloadErrorCode.decode(is, false);
				subCodeLength += berIdentifier.decode(is);
			}
			int nextByte = is.read();
			if (berIdentifier.tagNumber != 0 || berIdentifier.identifierClass != 0 || berIdentifier.primitive != 0
	...
	public String toString() {
		...
		sb.append(", ");
		sb.append("downloadErrorCode: ").append(downloadErrorCode);
