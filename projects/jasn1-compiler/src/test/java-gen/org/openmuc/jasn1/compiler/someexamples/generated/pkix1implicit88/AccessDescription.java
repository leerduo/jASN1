...
public class AccessDescription {
	...
	public BerObjectIdentifier accessMethod = null;
	...
	public AccessDescription(BerObjectIdentifier accessMethod, GeneralName accessLocation) {
		id = identifier;
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			codeLength = 0;
			codeLength += accessLocation.encode(os, true);
			
			codeLength += accessMethod.encode(os, true);
	...
	public int decode(InputStream is, boolean explicit) throws IOException {
		...
		if (totalLength == -1) {
			...
			int choiceDecodeLength = accessLocation.decode(is, berIdentifier);
		...
		accessLocation = new GeneralName();
		subCodeLength += accessLocation.decode(is, berIdentifier);
	...
	public String toString() {
		...
		sb.append(", ");
		sb.append("accessLocation: ").append(accessLocation);
