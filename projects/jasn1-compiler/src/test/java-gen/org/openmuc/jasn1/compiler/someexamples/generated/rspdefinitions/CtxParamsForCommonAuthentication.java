...
public class CtxParamsForCommonAuthentication {

	public static final BerIdentifier identifier = new BerIdentifier(BerIdentifier.UNIVERSAL_CLASS, BerIdentifier.CONSTRUCTED, 16);
	protected BerIdentifier id;

	public byte[] code = null;
	public BerUTF8String matchingId = null;
	...
	public CtxParamsForCommonAuthentication(BerUTF8String matchingId, DeviceInfo deviceInfo) {
		id = identifier;
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			codeLength = 0;
			codeLength += deviceInfo.encode(os, false);
			// write tag: CONTEXT_CLASS, CONSTRUCTED, 1
			os.write(0xa1);
			codeLength += 1;
			
			if (matchingId != null) {
				codeLength += matchingId.encode(os, false);
