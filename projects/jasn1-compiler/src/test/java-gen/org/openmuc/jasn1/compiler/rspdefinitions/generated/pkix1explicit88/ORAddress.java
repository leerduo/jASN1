...
public class ORAddress {
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			if (extensionAttributes != null) {
				codeLength += extensionAttributes.encode(os, true);
			}
			
			if (builtInDomainDefinedAttributes != null) {
				codeLength += builtInDomainDefinedAttributes.encode(os, true);
			}
			
			codeLength += builtInStandardAttributes.encode(os, true);
	...
	public int decode(InputStream is, boolean explicit) throws IOException {
		...
		if (berIdentifier.equals(BuiltInStandardAttributes.identifier)) {
		...
		if (berIdentifier.equals(BuiltInDomainDefinedAttributes.identifier)) {
		...
		if (berIdentifier.equals(ExtensionAttributes.identifier)) {
