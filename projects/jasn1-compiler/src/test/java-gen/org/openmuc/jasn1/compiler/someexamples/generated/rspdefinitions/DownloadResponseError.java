...
public class DownloadResponseError {
	...
	public DownloadResponseError() {
		id = identifier;
	}

	public DownloadResponseError(byte[] code) {
		id = identifier;
		this.code = code;
	}

	public DownloadResponseError(DownloadErrorCode downloadErrorCode, OctetTo16 transactionId) {
		id = identifier;
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			codeLength += downloadErrorCode.encode(os, false);
