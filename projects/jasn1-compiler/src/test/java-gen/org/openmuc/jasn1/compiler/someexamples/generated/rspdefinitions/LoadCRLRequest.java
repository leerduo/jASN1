...
public class LoadCRLRequest {

	public static final BerIdentifier identifier = new BerIdentifier(BerIdentifier.CONTEXT_CLASS, BerIdentifier.CONSTRUCTED, 53);
	protected BerIdentifier id;

	public byte[] code = null;
	public CertificateList crl = null;
	...
	public LoadCRLRequest(CertificateList crl) {
		id = identifier;
		this.crl = crl;
	}
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			codeLength = 0;
			codeLength += crl.encode(os, false);
