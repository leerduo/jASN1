...
public class NoticeReference {
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			codeLength += organization.encode(os, true);
	...
	public int decode(InputStream is, boolean explicit) throws IOException {
		...
		if (totalLength == -1) {
			...
			int choiceDecodeLength = organization.decode(is, berIdentifier);
			...
			if (berIdentifier.equals(NoticeNumbers.identifier)) {
		...
		subCodeLength += berIdentifier.decode(is);
		organization = new DisplayText();
		subCodeLength += organization.decode(is, berIdentifier);
		subCodeLength += berIdentifier.decode(is);
	...
	public String toString() {
		...
		sb.append(", ");
		sb.append("noticeNumbers: ").append(noticeNumbers);
