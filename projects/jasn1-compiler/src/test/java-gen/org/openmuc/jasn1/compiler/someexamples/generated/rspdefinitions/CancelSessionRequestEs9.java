...
public class CancelSessionRequestEs9 {

	public static final BerIdentifier identifier = new BerIdentifier(BerIdentifier.CONTEXT_CLASS, BerIdentifier.CONSTRUCTED, 65);
	...
	public CancelSessionRequestEs9(TransactionId transactionId, CancelSessionResponse cancelSessionResponse) {
		id = identifier;
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			codeLength = 0;
			codeLength += cancelSessionResponse.encode(os, false);
	...
	public int decode(InputStream is, boolean explicit) throws IOException {
		...
		if (totalLength == -1) {
			...
			int choiceDecodeLength = cancelSessionResponse.decode(is, berIdentifier);
			if (choiceDecodeLength != 0) {
				subCodeLength += choiceDecodeLength;
				subCodeLength += berIdentifier.decode(is);
			}
			else {
				cancelSessionResponse = null;
			}
		...
		cancelSessionResponse = new CancelSessionResponse();
		subCodeLength += cancelSessionResponse.decode(is, berIdentifier);
	...
	public String toString() {
		...
		sb.append(", ");
		sb.append("cancelSessionResponse: ").append(cancelSessionResponse);
