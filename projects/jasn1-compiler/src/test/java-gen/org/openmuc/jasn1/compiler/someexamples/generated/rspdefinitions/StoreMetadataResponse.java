...
public class StoreMetadataResponse {
	...
	public BerInteger storeMetaDataStatus = null;

	public StoreMetadataResponse() {
		id = identifier;
	}

	public StoreMetadataResponse(byte[] code) {
		id = identifier;
		this.code = code;
	}

	public StoreMetadataResponse(BerInteger storeMetaDataStatus) {
		id = identifier;
		this.storeMetaDataStatus = storeMetaDataStatus;
	}
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			codeLength = 0;
			codeLength += storeMetaDataStatus.encode(os, false);
	...
	public int decode(InputStream is, boolean explicit) throws IOException {
		...
		if (totalLength == -1) {
			...
			if (berIdentifier.equals(BerIdentifier.CONTEXT_CLASS, BerIdentifier.PRIMITIVE, 1)) {
				storeMetaDataStatus = new BerInteger();
				subCodeLength += storeMetaDataStatus.decode(is, false);
				subCodeLength += berIdentifier.decode(is);
			}
			int nextByte = is.read();
			if (berIdentifier.tagNumber != 0 || berIdentifier.identifierClass != 0 || berIdentifier.primitive != 0
	...
	public String toString() {
		...
		sb.append("storeMetaDataStatus: ").append(storeMetaDataStatus);
