...
public class DpProprietaryData {
	...
	public DpProprietaryData(byte[] code) {
		id = identifier;
		this.code = code;
	}

	public DpProprietaryData(BerObjectIdentifier dpOid) {
		id = identifier;
		this.dpOid = dpOid;
	}
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			codeLength = 0;
			codeLength += dpOid.encode(os, false);
	...
	public int decode(InputStream is, boolean explicit) throws IOException {
		...
		if (berIdentifier.equals(BerIdentifier.CONTEXT_CLASS, BerIdentifier.PRIMITIVE, 0)) {
			dpOid = new BerObjectIdentifier();
			subCodeLength += dpOid.decode(is, false);
