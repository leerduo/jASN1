...
public class NotificationSentResponse {
	...
	public static final BerIdentifier identifier = new BerIdentifier(BerIdentifier.CONTEXT_CLASS, BerIdentifier.CONSTRUCTED, 48);
	protected BerIdentifier id;

	public byte[] code = null;
	public BerInteger deleteNotificationStatus = null;

	public NotificationSentResponse() {
		id = identifier;
	}

	public NotificationSentResponse(byte[] code) {
		id = identifier;
		this.code = code;
	}

	public NotificationSentResponse(BerInteger deleteNotificationStatus) {
		id = identifier;
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			codeLength = 0;
			codeLength += deleteNotificationStatus.encode(os, false);
	...
	public int decode(InputStream is, boolean explicit) throws IOException {
		...
		if (totalLength == -1) {
			...
			if (berIdentifier.equals(BerIdentifier.CONTEXT_CLASS, BerIdentifier.PRIMITIVE, 0)) {
				...
				subCodeLength += deleteNotificationStatus.decode(is, false);
				subCodeLength += berIdentifier.decode(is);
			}
			int nextByte = is.read();
			if (berIdentifier.tagNumber != 0 || berIdentifier.identifierClass != 0 || berIdentifier.primitive != 0
	...
	public String toString() {
		...
		sb.append("deleteNotificationStatus: ").append(deleteNotificationStatus);
