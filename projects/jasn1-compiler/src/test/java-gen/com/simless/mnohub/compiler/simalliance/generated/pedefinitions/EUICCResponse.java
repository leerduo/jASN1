...
public class EUICCResponse {
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			if (statusMessage != null) {
				codeLength += statusMessage.encode(os, true);
			}
			
			if (profileInstallationAborted != null) {
				codeLength += profileInstallationAborted.encode(os, true);
			}
			
			codeLength += peStatus.encode(os, true);
	...
	public int decode(InputStream is, boolean explicit) throws IOException {
		...
		if (length.val == -1) {
			...
			if (berIdentifier.equals(SubSeqOf_peStatus.identifier)) {
