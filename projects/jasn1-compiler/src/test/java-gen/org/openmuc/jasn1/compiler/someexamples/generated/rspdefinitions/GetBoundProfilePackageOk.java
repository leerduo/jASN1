...
public class GetBoundProfilePackageOk {
	...
	public BoundProfilePackage boundProfilePackage = null;
	...
	public GetBoundProfilePackageOk(TransactionId transactionId, BoundProfilePackage boundProfilePackage) {
		id = identifier;
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			codeLength = 0;
			codeLength += boundProfilePackage.encode(os, false);
	...
	public int decode(InputStream is, boolean explicit) throws IOException {
		...
		if (totalLength == -1) {
			...
			if (berIdentifier.equals(BerIdentifier.CONTEXT_CLASS, BerIdentifier.CONSTRUCTED, 54)) {
				...
				subCodeLength += boundProfilePackage.decode(is, false);
				subCodeLength += berIdentifier.decode(is);
			}
			int nextByte = is.read();
			if (berIdentifier.tagNumber != 0 || berIdentifier.identifierClass != 0 || berIdentifier.primitive != 0
	...
	public String toString() {
		...
		sb.append(", ");
		sb.append("boundProfilePackage: ").append(boundProfilePackage);
