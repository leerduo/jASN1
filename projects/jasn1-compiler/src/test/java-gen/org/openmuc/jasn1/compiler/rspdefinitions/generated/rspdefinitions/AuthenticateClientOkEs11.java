...
public class AuthenticateClientOkEs11 {
	...
	public static class MyEventEntries {
		...
		public MyEventEntries(byte[] code) {
			id = identifier;
			this.code = code;
		}

		public MyEventEntries(List<EventEntries> seqOf) {
			id = identifier;
			this.seqOf = seqOf;
		}
	...
	public MyEventEntries myEventEntries = null;
	...
	public AuthenticateClientOkEs11(TransactionId transactionId, MyEventEntries myEventEntries) {
		id = identifier;
		this.transactionId = transactionId;
		this.myEventEntries = myEventEntries;
	}
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (code != null) {
			...
			codeLength = 0;
			codeLength += myEventEntries.encode(os, false);
	...
	public int decode(InputStream is, boolean explicit) throws IOException {
		...
		if (berIdentifier.equals(BerIdentifier.CONTEXT_CLASS, BerIdentifier.CONSTRUCTED, 1)) {
			myEventEntries = new MyEventEntries();
			subCodeLength += myEventEntries.decode(is, false);
			if (subCodeLength == totalLength) {
				return codeLength;
			}
		}
	...
	public String toString() {
		...
		sb.append(", ");
		sb.append("myEventEntries: ").append(myEventEntries);
