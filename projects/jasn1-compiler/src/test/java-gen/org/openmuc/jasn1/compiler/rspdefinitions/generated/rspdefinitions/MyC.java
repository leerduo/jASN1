...
public class MyC {
	...
	public BerInteger isdpAid = null;

	public BerInteger iccid = null;

	public MyC() {
	}

	public MyC(byte[] code) {
		this.code = code;
	}

	public MyC(BerInteger isdpAid, BerInteger iccid) {
