...
public class File {
	...
	public static class SubChoice {
		...
		public SubChoice(BerNull doNotCreate, Fcp fileDescriptor, UInt16 fillFileOffset, BerOctetString fillFileContent) {
		...
		public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
			...
			if (fillFileContent != null) {
				codeLength += fillFileContent.encode(os, true);
				return codeLength;
			...
			if (fileDescriptor != null) {
				codeLength += fileDescriptor.encode(os, true);
				return codeLength;

			}
			
			if (doNotCreate != null) {
				codeLength += doNotCreate.encode(os, true);
				return codeLength;
		...
		public int decode(InputStream is, BerIdentifier berIdentifier) throws IOException {
			...
			if (berIdentifier.equals(Fcp.identifier)) {
	...
	public File(List<SubChoice> seqOf) {
		id = identifier;
		this.seqOf = seqOf;
	}
